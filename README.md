...
| 加载器 | Minecraft |
|---|---|
| Fabric（需 Fabric API） | 1.21.2 ~ 1.21.5 |
| NeoForge | 1.21.2 ~ 1.21.5 |
...
- `onlytpviolentbuild-1.2.0-fabric-1.21.2-1.21.5.jar`
- `onlytpviolentbuild-1.2.0-neoforge-1.21.2-1.21.5.jar`
