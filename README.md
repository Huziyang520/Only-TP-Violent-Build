...
| 加载器 | Minecraft |
|---|---|
| Fabric（需 Fabric API） | 1.21 ~ 1.21.1 |
| Forge | 1.21 ~ 1.21.1 |
...
- `onlytpviolentbuild-1.2.0-fabric-1.21-1.21.1.jar`
- `onlytpviolentbuild-1.2.0-forge-1.21-1.21.1.jar`
- `onlytpviolentbuild-1.2.0-neoforge-1.21-1.21.1.jar`
