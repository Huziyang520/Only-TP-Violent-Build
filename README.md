...
| 加载器 | Minecraft |
|---|---|
| Fabric（需 Fabric API） | 1.21.6 ~ 1.21.8 |
| NeoForge | 1.21.6 ~ 1.21.8 |
...
- `onlytpviolentbuild-1.2.0-fabric-1.21.6-1.21.8.jar`
- `onlytpviolentbuild-1.2.0-neoforge-1.21.6-1.21.8.jar`
